...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gradient-to-b from-gray-900 to-black' : 'bg-gradient-to-b from-blue-900 to-indigo-900'} text-white transition-colors duration-500`}>
      ...
      {/* Navigation - glass effect when scrolling */}
      <nav className={`fixed w-full z-40 transition-all duration-300 ${scrollPosition > 50 ? 'glass-effect py-2' : 'py-4'}`}>
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="text-2xl font-bold text-gradient">Team Blitz</div>
              <div className="animate-pulse ml-2">⚡</div>
              <div className="text-sm ml-2 opacity-80">Aditya's Team</div>
            </div>
            ...
            <div className="md:hidden flex items-center">
              <button
                type="button"
                onClick={toggleDarkMode}
                className="p-2 mr-4 rounded-full hover:bg-blue-800/30 transition-colors"
                aria-label={darkMode ? "Switch to light mode" : "Switch to dark mode"}
              >
                {darkMode ? (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="container mx-auto px-6 py-20 text-center relative">
          ...
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 relative">
              ...
              <span className="block mt-2">Aditya's Hackathon Team</span>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6 animate-slide-up delay-300">
              <a
                href="#projects"
              ...
              <a
                href="#contact"
                className="glass-effect hover:bg-blue-700/30 text-white font-bold py-4 px-10 rounded-full transition-all duration-300 border border-white/20 hover:border-white/50 hover:-translate-y-1 hover-scale"
              >
                Contact Us
              </a>
            </div>
                ...
                <div className="grid grid-cols-1 gap-12">
                  <div className="relative">
                    ...
                    <div className="glass-effect p-6 rounded-lg mt-4 hover-scale">
                      <h4 className="text-xl font-bold mb-2">2023</h4>
                      <p>Won first place at the Global Tech Hackathon with our AI-powered environmental monitoring solution.</p>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="glass-effect p-6 rounded-lg mt-4 hover-scale">
                      <h4 className="text-xl font-bold mb-2">2022</h4>
                      <p>Expanded our team to include UX designers and product managers, creating more well-rounded solutions.</p>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="glass-effect p-6 rounded-lg mt-4 hover-scale">
                      <h4 className="text-xl font-bold mb-2">2021</h4>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="glass-effect rounded-xl overflow-hidden group hover-scale">
                <div className="h-64 relative overflow-hidden bg-gradient-to-br from-green-500/20 to-teal-500/20">
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <div className="w-32 h-32 rounded-full bg-green-500/30 mb-2 flex items-center justify-center overflow-hidden border-2 border-white/30">
                      ...
                      <img
                        src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23ffffff80'%3E%3Cpath d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z'/%3E%3C/svg%3E"
                        alt="Aniket (Aayush Tonk)"
                        className="w-full h-full object-cover object-center"
                      />
                    </div>
                    <span className="text-sm opacity-70">Aniket (Aayush Tonk)</span>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                    <div className="flex space-x-3">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-2">Aniket (Aayush Tonk)</h3>
      ...
      <section id="projects" className="py-20 bg-black/20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          {/* Featured Project */}
          <div className="max-w-5xl mx-auto mb-20 glass-effect rounded-xl overflow-hidden hover-scale">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Project 1 */}
            <div className="glass-effect rounded-xl overflow-hidden group hover-scale">
              <div className="h-48 bg-gradient-to-br from-green-500/20 to-blue-500/20 relative">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">EcoTrack</h3>
                <p className="text-blue-300 mb-4">Environmental Monitoring App</p>
                <p className="text-sm mb-4">An IoT-based solution for monitoring air quality and environmental metrics in urban areas.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">React</span>
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">Node.js</span>
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">IoT</span>
                </div>
              </div>
            </div>
            ...
            {/* Project 2 */}
            <div className="glass-effect rounded-xl overflow-hidden group hover-scale">
              <div className="h-48 bg-gradient-to-br from-purple-500/20 to-pink-500/20 relative">
                <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <p className="text-blue-300 mb-4">Healthcare Platform</p>
                <p className="text-sm mb-4">A telemedicine platform connecting patients with healthcare providers in underserved areas.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">Next.js</span>
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">WebRTC</span>
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">MongoDB</span>
                </div>
              </div>
            </div>
            ...
            {/* Project 3 */}
            <div className="glass-effect rounded-xl overflow-hidden group hover-scale">
              <div className="h-48 bg-gradient-to-br from-amber-500/20 to-orange-500/20 relative">
                <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">FinLit</h3>
                <p className="text-blue-300 mb-4">Financial Literacy App</p>
                <p className="text-sm mb-4">An educational platform teaching financial literacy to young adults through interactive lessons.</p>
                <div className="flex flex-wrap gap-2">
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">React Native</span>
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">Firebase</span>
                  <span className="glass-effect px-2 py-1 rounded-full text-xs">Gamification</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <a
              href="#"
              className="inline-flex items-center glass-effect hover:bg-blue-700/30 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 border border-white/20 hover:border-white/50"
            >
              View All Projects
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
      ...
      <section id="contact" className="py-20 relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-20 left-10 w-40 h-40 rounded-full bg-blue-500/10 animate-float"></div>
        <div className="absolute bottom-20 right-10 w-60 h-60 rounded-full bg-indigo-500/10 animate-float delay-300"></div>
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Contact Info */}
              <div className="glass-effect rounded-xl p-8 hover-scale">
                <h3 className="text-2xl font-bold mb-6">Contact Information</h3>
                <p className="mb-8 text-lg">
                  Interested in collaborating with us or want to learn more about our team? Reach out to us through any of these channels:
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:adityakumartiwari2004@gmail.com" className="hover:text-blue-300 transition-colors">adityakumartiwari2004@gmail.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-blue-300">Location</h4>
                      <p>Innovation Hub, Tech Valley, CA 94103</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-blue-300">Social Media</h4>
                      <div className="flex space-x-4 mt-2">
                        <a href="#" className="text-white hover:text-blue-300 transition-colors" aria-label="Twitter" title="Twitter">
                          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                          </svg>
                        </a>
                        <a href="#" className="text-white hover:text-blue-300 transition-colors" aria-label="GitHub" title="GitHub">
                          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" className="text-white hover:text-blue-300 transition-colors" aria-label="LinkedIn" title="LinkedIn">
                          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-12 pt-8 border-t border-blue-800/30">
                  ...
                  <p className="mb-4">Stay updated with our latest projects and hackathon wins!</p>
                  <div className="flex">
                    <input
                      type="email"
                      placeholder="Your Email"
                      className="flex-grow p-3 rounded-l-lg bg-blue-900/50 border border-blue-700 focus:outline-none focus:border-blue-400"
                    />
                    <button
                      type="button"
                      className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-r-lg transition-colors"
                    >
                      Subscribe
                    </button>
                  </div>
                ...
                <form className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 rounded-lg bg-blue-900/50 border border-blue-700 focus:outline-none focus:border-blue-400 transition-colors"
                    />
                  </div>
                  ...
                  <div className="pt-4">
                    <button
                      type="button"
                      className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg"
                    >
                      Send Message
                    </button>
                  </div>
        ...
        <div className="container mx-auto px-6 relative">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">adityakumartiwari2004@gmail.com</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  ...
                  <span className="text-gray-300">Innovation Hub, Tech Valley, CA 94103</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Team Blitz - Aditya Kumar Tiwari. All rights reserved.
            </div>

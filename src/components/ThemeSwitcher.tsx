...
type Theme = "default" | "dark" | "cyberpunk" | "minimal";
  ...
  return (
    <div className="relative">
      <button
        ...
        className="p-2 rounded-full bg-gradient-to-r from-blue-600/20 to-indigo-600/20 hover:from-blue-600/30 hover:to-indigo-600/30 transition-all duration-300 flex items-center hover:scale-105 border border-white/10"

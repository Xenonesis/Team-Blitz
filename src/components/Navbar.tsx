    ...
    <>
        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between">
              ...
              <div className="relative">
                ...
                <div className="relative flex items-center bg-white/5 dark:bg-blue-900/20 backdrop-blur-md px-5 py-2.5 rounded-full border border-blue-400/30 dark:border-blue-500/30 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]">
                  <div className="text-xl sm:text-2xl font-bold text-gradient-enhanced group-hover:scale-105 transition-transform duration-300">
                    ...
                    <span className="text-blue-500 dark:text-blue-400 font-extrabold">Blitz</span>
                  </div>
            ...
            <div className="hidden md:flex items-center space-x-2">
                  ...
                  link.href.startsWith("/") ? (
                    <Link
                      ...
                      className={`relative px-5 py-2 rounded-full transition-all duration-300 group ${
                        (activeSection === link.href.substring(1) || (activeSection === "projects" && link.label === "Projects"))
                          ? "text-white font-medium bg-gradient-to-r from-blue-500/30 to-indigo-500/30 border border-blue-400/40 shadow-md"
                          : "text-white hover:text-white hover:bg-gradient-to-r hover:from-blue-500/20 hover:to-indigo-500/20 hover:scale-105"
                      }`}
                    >
                      ...
                      <span
                        className={`absolute inset-0 rounded-full bg-gradient-to-r from-blue-500/0 to-indigo-500/0 group-hover:from-blue-500/10 group-hover:to-indigo-500/10 transition-all duration-300 ${
                          (activeSection === link.href.substring(1) || (activeSection === "projects" && link.label === "Projects"))
                            ? "opacity-100"
                      ...
                      ></span>
                      <span
                        className={`absolute bottom-0 left-1/2 h-0.5 bg-blue-400 dark:bg-blue-300 rounded-full transform -translate-x-1/2 transition-all duration-300 ${
                          (activeSection === link.href.substring(1) || (activeSection === "projects" && link.label === "Projects"))
              ...
              <div className="ml-4">
                <ThemeSwitcher
                  className="transform hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-blue-500/20 text-white hover:bg-gradient-to-r hover:from-blue-500/20 hover:to-indigo-500/20 rounded-full p-2"
                />
              </div>
            </div>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-black/80 z-50 md:hidden backdrop-blur-lg animate-fade-in">
          <div className="mobile-menu-container absolute right-0 top-0 h-full w-[85%] max-w-[320px] modern-mobile-menu animate-slide-right">

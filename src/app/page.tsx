              ...
              <div className="glass-effect rounded-xl overflow-hidden group hover-scale">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm">Talented developer with a passion for creating beautiful, responsive user interfaces and engaging user experiences.</p>
                      ...
                      {/* Team Member - Muneer Ali */}
        <div className="glass-effect rounded-xl overflow-hidden group hover-scale">
          <div className="h-64 relative overflow-hidden bg-gradient-to-br from-cyan-500/20 to-blue-500/20">
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <div className="w-32 h-32 rounded-full bg-cyan-500/30 mb-2 flex items-center justify-center overflow-hidden border-2 border-white/30">
                <div className="w-full h-full flex items-center justify-center text-white opacity-80">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-16 h-16">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
              <div className="flex space-x-3">
                ...
                <a href="https://www.github.com/Muneerali199" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-300 transition-colors" aria-label="GitHub profile" title="GitHub profile">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                  </svg>
                  <span className="sr-only">GitHub</span>
          ...
          <div className="p-6">
            ...
            <p className="text-sm">Passionate web3 enthusiast with expertise in building modern, responsive applications across the entire stack.</p>
          </div>
        </div>
            </div>
          </div>
